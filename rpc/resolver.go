...
var (
	...
	engineServ = flag.String("engine service",
		"toad_ocr_service", "engine service name")
	processorServ = flag.String("processor service",
		"toad_ocr_preprocessor", "processor service name")
	defaultDiscoverUrl  = flag.String("default dis url",
		"http://localhost:2379", "default etcd service discover address")
)
